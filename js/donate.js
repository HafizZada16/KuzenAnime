export async function loadDonate() {
  ...
  document.title = "Donate & Support - KuzenAnime";
  ...
  display.innerHTML = `
        <div class="max-w-3xl mx-auto animate-fadeIn px-2">
            ...
            <div class="space-y-4">
                ...
                <a href="https://tako.id/Hapiz16" target="_blank" class="flex items-center gap-4 bg-[#121212] border border-gray-800 p-4 rounded-2xl hover:border-[#ff6600] hover:bg-orange-950/10 transition-all group shadow-sm">
